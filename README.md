...
$$|\text{Tr}(\rho\: \mathcal{B}_{CHSH})| \leq 2$$
...
$$\mathcal{B}_{CHSH} = \vec{a} \cdot \vec{\sigma} \otimes (\vec{b} +\vec{b}') \cdot \vec{\sigma} + \vec{a}' \cdot \vec{\sigma} \otimes(\vec{b} - \vec{b}') \cdot \vec{\sigma}$$
...
$E(\vec{a},\vec{b}) = \text{Tr}[\rho (\vec{a} \cdot \vec{\sigma} \otimes \vec{b} \cdot \vec{\sigma})]$
...
$$\vec{a} \cdot \vec{\sigma} \otimes (\vec{b} +\vec{b}') \cdot \vec{\sigma} + \vec{a}' \cdot \vec{\sigma} \otimes(\vec{b} - \vec{b}') \cdot \vec{\sigma}$$
...
$$\rho = \frac{1}{4}(I\otimes I + \vec{r} \cdot \vec{\sigma} \otimes I + I \otimes \vec{s} \cdot \vec{\sigma} + \sum_{n, m = 1}^{3}{T_{n,m}\sigma_n \otimes \sigma_m}) $$
